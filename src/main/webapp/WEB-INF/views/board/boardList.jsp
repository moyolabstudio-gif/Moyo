            ...
            <div class="board-hero-copy">
                ...
                <p>
                    <c:choose>
                        ...
                        <c:when test="${false}">업무와 모임에 필요한 파일과 자료를 한곳에서 관리합니다.</c:when>
                ...
                <c:when test="${not empty projId}">
                    <form class="board-search-form" method="get" action="/project/board/list">
                        ...
                        <select name="searchType" class="board-search-select">
                            ...
                            <c:if test="${false}"><option value="fileName" ${searchType eq 'fileName' ? 'selected' : ''}>파일명</option></c:if>
                        </select>
                        <input type="text" name="keyword" value="${keyword}" class="board-search-input" placeholder="제목, 내용, 작성자로 검색">
                        ...
                        <c:otherwise>
                            <tr>
                                <td colspan="7" class="board-empty-cell">
                                    <div class="board-empty board-empty-rich ${boardType eq 'NOTICE' ? 'board-empty-notice' : 'board-empty-free'}">
                                        ...
                                        <div class="board-empty-copy">
                                            <strong>
                                                <c:choose>
                                                    ...
                                                    <c:when test="${false}">아직 등록된 자료가 없습니다.</c:when>
                                            ...
                                            <span>
                                                <c:choose>
                                                    ...
                                                    <c:when test="${false}">회의 자료, 문서, 참고 파일을 이곳에 모아보세요.</c:when>
                                                    ...
                                                    <c:when test="${not empty projId}">
                                                        ...
                                                        <a class="board-empty-action" href="/group/board/write?wsId=${wsId}&projId=${projId}&type=${boardType}">
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${false}">자료 등록하기</c:when>
